jQuery(document).ready(function($){
	...
	$('.wordpress-widget').each(function(){
		...
		if (i === 0) $('head').append(
			...
			+ '@media only screen and (max-width: 1280px) { .wordpress-box .wordpress-box-download .download { position: relative; left: auto; right: auto; top: auto; text-align: center; margin-top: 1em; } }'
